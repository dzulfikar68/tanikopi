                    ...
                    <form method="POST" action="{{ action('RegisterController@store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="pembeli">{{ __('Pembeli') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="role" id="Pengolah Kopi" value="Pengolah Kopi">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-success" style="background-color:#0da857">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
